...
(function($)
{
    ...
    {
        /**
        *  Creates a jaTextbox object for handling placeholder text inside a textbox
        *  @class
        *  A object which will give a textbox true placeholder text, which will be visible inside the textbox
        *  even when the textbox has focus.  Once the user begins entering text, the placeholder text will disappear.
        *  If all of the text is deleted from the textbox, the placeholder text will reappear
        *  @param {String} sHolderId ID of the direct parent element of the textbox. This element should have a width set to the desired width of the textbox
        *  @param {String} sTxtbxId ID of the textbox input element. This element should have a width of 100%
        *  @param {String} sExampleText Placeholder text to display in the textbox when empty.
        *  @returns {Object}
        */
    ...
    $.jaTextbox.prototype =
    {
        ...
        evt_Hint_onclick: function(oEvt) { this.get_Textbox().trigger($.Event($.On.Focus)) },
